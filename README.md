...
Developed and deployed an open-loop Field Oriented Control (FOC) algorithm for a Lucas Nuelle three-phase induction motor using the TI C2000 platform. Focused on precise PWM generation and efficient motor phase modulation. <br>
